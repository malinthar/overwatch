...
module.exports = "<h2 class=\"page-header\">Login</h2>\n<form (submit)=\"onLoginSubmit()\">\n  <div class=\"form-group\">\n     <label>Username</label>\n     <input type=\"text\" class=\"form-control\" [(ngModel)]=\"username\"  [ngModelOptions]=\"{standalone: true}\" name=\"username\">\n\n  </div>\n  <div class=\"form-group\">\n    <label>Password</label>\n    <input type=\"text\" class=\"form-control\" [(ngModel)]=\"password\"   [ngModelOptions]=\"{standalone: true}\" name=\"password\">\n\n </div>\n <input type=\"submit\" class=\"btn btn-primary\" value=\"Login\">\n \n</form>\n"
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            ...
            if (data.success) {
                ...
                _this.flashMessage.showFlashMessage({ messages: ['LogIn Sucessfull!!'],
                    dismissible: true,
                    timeout: 10000,
                    type: 'success' });
                ...
                _this.flashMessage.showFlashMessage({ messages: [data.msg],
                    dismissible: true,
                    timeout: 10000,
                    type: 'danger' });
...
module.exports = "<div *ngIf=\"user\">\n  <h2 calss=\"page-header\">{{user.name}}</h2>\n  <ul class=\"list-group\">\n  <li class=\"list-group-item\">Username:{{user.username}}</li>\n  <li class=\"list-group-item\">Email:{{user.email}}</li>\n  </ul>\n\n</div>\n"
...
module.exports = "<h2 class=\"page-header\">Register</h2>\n<form (ngSubmit)=\"onRegisterSubmit()\">\n    <div class=\"form-group\">\n        <label for=\"name\">Name</label>\n        <input type=\"text\" [(ngModel)]=\"name\" class=\"form-control\" [ngModelOptions]=\"{standalone: true}\"  placeholder=\"Your name\">\n    </div>\n    <div class=\"form-group\">\n        <label for=\"name\">username</label>\n        <input type=\"text\" [(ngModel)]=\"username\" class=\"form-control\" [ngModelOptions]=\"{standalone: true}\"  placeholder=\"username\">\n    </div>\n\n    <div class=\"form-group\">\n        <label for=\"email\">email</label>\n        <input type=\"email\" [(ngModel)]=\"email\" class=\"form-control\"  [ngModelOptions]=\"{standalone: true}\" placeholder=\"Email\">\n    </div>\n    <div class=\"form-group\">\n        <label for=\"password\">Password</label>\n        <input type=\"password\" [(ngModel)]=\"password\" class=\"form-control\" [ngModelOptions]=\"{standalone: true}\" placeholder=\"New Password\">\n    </div>\n    <div class=\"form-group\">\n        <input type=\"submit\" class=\"form-control\" name=\"subbutton\"/>\n    </div>\n</form>\n\n<p>{{name}}</p>\n<p>{{username}}</p>\n<p>{{email}}</p>\n<P>{{password}}</P>\n\n"
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(valiadteService, flashMessage, authService, router) {
        this.valiadteService = valiadteService;
        this.flashMessage = flashMessage;
        this.authService = authService;
        this.router = router;
    }
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.showFlashMessage({ messages: ['Registration Successful'],
                    dismissible: true,
                    timeout: 10000,
                    type: 'success' });
                _this.router.navigateByUrl('/login');
                ...
                _this.flashMessage.showFlashMessage({ messages: ['Registration Unsuccssful'],
                    dismissible: true,
                    timeout: 10000,
                    type: 'danger' });
...
module.exports = __webpack_require__(/*! E:\Projects\OWMean\frontend\src\main.ts */"./src/main.ts");
